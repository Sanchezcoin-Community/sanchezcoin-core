...
function Mainnet(callback) {
    ...
    let sanchezcoin = new Coin(8, "3eecf85c306b5c", 110700, 800);                                                   // Gibt den Coin an, welcher verwendet werden soll
    ...
    let genesis_block = generateGenesisMainnetBlock("1e00ffff", 1668568992542, 716457350, hash_algo, "9b65ac81d16a8cab6e07e31a7870bdcf966a7de0595dde0318de5e91b878ca5b", sanchezcoin);
    ...
    let chain_object = new Blockchain(genesis_block, sanchezcoin, chainparms);
