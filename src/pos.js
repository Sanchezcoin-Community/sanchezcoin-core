...
function mintNewBlock(wallet_obj, blockchain_obj, callback) {
    ...
    (async() => {
        while(run_loop) {
            ...
            let block_template = await blockchain_obj.getPoSMintingBlockTemplate('9b65ac81d16a8cab6e07e31a7870bdcf966a7de0595dde0318de5e91b878ca5b', '9b65ac81d16a8cab6e07e31a7870bdcf966a7de0595dde0318de5e91b878ca5b');
