...
## ConditionsScript 💬
Condition script is a simple script used to lock or unlock transactions. [Read more](https://github.com/Sanchezcoin-Community/sanchezcoin-core/blob/main/src/scriptvm/docs/README.md)
